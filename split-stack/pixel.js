...
var GLYPH = {
  ...
  '>':['.#...','..#..','...#.','....#','...#.','..#..','.#...'],
  '-':['.....','.....','.....','#####','.....','.....','.....'],
  /* Scoring needed a plus and the font had never been asked for one. Same
     five by seven as the minus it pairs with, so +1 and -2 sit at the same
     width and a column of them lines up. */
  '+':['.....','..#..','..#..','#####','..#..','..#..','.....'],
  '.':['.....','.....','.....','.....','.....','.##..','.##..'],
  'B':['####.','#...#','#...#','####.','#...#','#...#','####.'],
  'C':['.###.','#...#','#....','#....','#....','#...#','.###.'],
